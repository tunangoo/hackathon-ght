...
const chatMessages = [
  ...
  { id: 6, sender: "You", message: "Can you summarize the timeline discussion?", time: "2:38 PM", isAI: false },
  { id: 7, sender: "AI Assistant", message: "The timeline discussion focused on Q4 deliverables. The team identified potential risks in the current schedule, particularly around the product launch and third-party integrations. The next milestone review is scheduled for next Thursday.", time: "2:39 PM", isAI: true },
  { id: 8, sender: "You", message: "What about the marketing resources?", time: "2:41 PM", isAI: false },
  { id: 9, sender: "AI Assistant", message: "The marketing team requested additional resources for the campaign launch. This needs approval from leadership. Lisa was assigned to review the Q4 marketing strategy by next Friday.", time: "2:42 PM", isAI: true },
  { id: 10, sender: "You", message: "Any client feedback mentioned?", time: "2:44 PM", isAI: false },
  { id: 11, sender: "AI Assistant", message: "Yes! Customer feedback from beta testing was overwhelmingly positive with a 95% satisfaction rate. Sarah is scheduled to follow up with clients next week.", time: "2:45 PM", isAI: true },
  { id: 12, sender: "You", message: "Thanks for the summary!", time: "2:47 PM", isAI: false },
  { id: 13, sender: "AI Assistant", message: "You're welcome! Is there anything else about the meeting you'd like to know more about?", time: "2:48 PM", isAI: true }
];

export default function MeetingInfo() {
  return (
    <div className="w-96 border-l border-gray-200 h-full overflow-hidden flex flex-col">
      <Tabs defaultValue="summary" className="h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <TabsContent value="summary" className="flex-1 flex flex-col min-h-0 m-0 p-0">
            <div className="flex-1 px-6 py-4 overflow-y-auto">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      <input type="checkbox" className="mt-1 rounded border-gray-300" />
                      <div className="flex-1">
                        <p className="text-sm font-medium">Review Q4 marketing strategy</p>
                        <p className="text-xs text-gray-500">Due: Next Friday - <strong>Lisa</strong></p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      <input type="checkbox" className="mt-1 rounded border-gray-300" />
                      <div className="flex-1">
                        <p className="text-sm font-medium">Prepare client presentation</p>
                        <p className="text-xs text-gray-500">Due: Wednesday - <strong>Tom</strong></p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="font-medium text-gray-800 mb-3">📋 Meeting Notes</h4>
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <div className="text-sm text-gray-600 space-y-2">
                      <p>• The team discussed the upcoming product launch timeline and identified potential risks in the current schedule.</p>
                      <p>• Marketing team requested additional resources for the campaign launch, which needs approval from leadership.</p>
                      <p>• Technical team raised concerns about the integration timeline with third-party services.</p>
                      <p>• Customer feedback from beta testing has been overwhelmingly positive, with 95% satisfaction rate.</p>
                      <p>• Next milestone review is scheduled for next Thursday at 2 PM.</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                      ...
                      <span className="text-sm">Product Roadmap Q4 2024</span>
                    </div>
                    <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-sm">Marketing Campaign Guidelines</span>
                    </div>
                    <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                      <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                      <span className="text-sm">Technical Architecture Document</span>
                    </div>
                  </div>
                </div>
              </div>
